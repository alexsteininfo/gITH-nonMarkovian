...
const RAW       = joinpath(@__DIR__, "..", "..", "data", "raw_subsampled",       "selection_2")
const PROC      = joinpath(@__DIR__, "..", "..", "data", "processed_subsampled", "selection_2")
const FULL_PROC = joinpath(@__DIR__, "..", "..", "data", "processed",            "selection_2")
