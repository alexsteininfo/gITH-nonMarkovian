...
function process_file(raw_path::String, proc_dir::String, full_restarts_path::String,
    ...
    isfile(full_restarts_path) ||
        error("$label: missing $full_restarts_path — run code/data_generation/3_processing/full_trees/process_sel2.jl first")
    ...
    isfile(full_params_path) ||
        error("$label: missing $full_params_path — run code/data_generation/3_processing/full_trees/process_sel2.jl first")
