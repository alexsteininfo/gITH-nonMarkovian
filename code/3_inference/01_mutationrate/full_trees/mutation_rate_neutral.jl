# Mutation-rate inference on full neutral trees.
#
...
# to data/inference/mutationrate/neutral/full_trees/<stem>.jls with atomic
# writes and shard-level resumability.
#
# Inputs:  data/raw/neutral/{deterministic,gamma,markov}/*.jls
# Outputs: data/inference/mutationrate/neutral/full_trees/<stem>.jls
...
#
# Usage:
#   julia --project=. -t auto code/3_inference/01_mutationrate/full_trees/mutation_rate_neutral.jl
#
...
const OUT_ROOT = joinpath(DATA, "inference", "mutationrate", "neutral", "full_trees")
mkpath(OUT_ROOT)
