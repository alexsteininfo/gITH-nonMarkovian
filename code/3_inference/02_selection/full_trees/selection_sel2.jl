# Selection inference on full sel_2 trees.
#
...
# data/inference/selection/selection_2/full_trees/<stem>.jls with atomic writes
# and shard-level resumability.
#
# Inputs:  data/raw/selection_2/{deterministic,gamma,markov}/*.jls
# Outputs: data/inference/selection/selection_2/full_trees/<stem>.jls
...
#
# Usage:
#   julia --project=. -t auto code/3_inference/02_selection/full_trees/selection_sel2.jl
#
...
const OUT_ROOT = joinpath(DATA, "inference", "selection", "selection_2", "full_trees")
mkpath(OUT_ROOT)
